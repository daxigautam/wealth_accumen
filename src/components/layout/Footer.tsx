          ...
          <div className="lg:col-span-4">
            ...
            <div className="flex items-center gap-4 mb-4">
              <a
                ...
                className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white/60 hover:text-[#D4AF37] hover:border-[#D4AF37]/30 hover:bg-[#D4AF37]/5 transition-all"
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={link.label}>
                  <Link
                    href={link.href}
                    className="text-sm text-white/60 hover:text-[#D4AF37] transition-colors font-medium flex items-center gap-2 group"
                  >
