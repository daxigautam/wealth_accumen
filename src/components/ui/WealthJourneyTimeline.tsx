    ...
    <section className="relative px-4 sm:px-6 lg:px-8 max-w-[90rem] mx-auto mt-20 sm:mt-32 z-30 mb-16 sm:mb-24">
      ...
      <div className="text-center mb-12 sm:mb-16">
        <div className="inline-flex items-center justify-center gap-4 mb-4">
          ...
          <h2 className="text-sm font-bold tracking-[0.2em] uppercase text-[#D4AF37]">Your Wealth Journey</h2>
          <div className="h-px w-12 bg-gradient-to-l from-transparent to-[#D4AF37]" />
        </div>
        <h3 className="font-[family-name:var(--font-outfit)] text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-[1.2] tracking-tight">
          A proven path to{" "}
      ...
      <div className="bg-white/95 backdrop-blur-2xl border border-white/30 rounded-[2.5rem] p-6 sm:p-8 lg:p-10 shadow-[0_30px_60px_rgba(4,15,45,0.1)] relative overflow-hidden group">
        {/* Glow effect */}
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 xl:gap-20 items-center">
          ...
          <div className="lg:col-span-5 text-center lg:text-left flex flex-col justify-start gap-8 self-start pt-10 sm:pt-14">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center lg:justify-start gap-x-3 gap-y-2 text-3xl sm:text-4xl lg:text-5xl font-[family-name:var(--font-playfair)] italic">
              <span className="text-[#040F2D]">We help you</span>
              <div className="relative w-[320px] sm:w-[380px] text-center sm:text-left h-[50px] flex items-center">
                <AnimatePresence mode="wait">
                  <motion.span
                    ...
                    className="absolute left-0 text-[#C59B27] font-bold whitespace-nowrap w-full sm:w-auto"
                  >
            ...
            <p className="text-base sm:text-lg text-slate-600 mx-auto lg:mx-0 leading-relaxed pr-0 lg:pr-8">
          ...
          <div className="lg:col-span-3 relative flex justify-center lg:justify-start lg:pl-4">
            <div className="relative flex flex-col gap-6 lg:gap-8">
              ...
              <div className="absolute top-4 bottom-4 left-[23px] sm:left-[27px] w-1 bg-[#040F2D]/10 rounded-full" />
                  ...
                  >
                    ...
                    <motion.div 
                      className={`w-12 h-12 sm:w-14 sm:h-14 rounded-full flex items-center justify-center shrink-0 border-2 transition-all duration-700
                        ${isActive ? 'bg-[#040F2D] border-[#D4AF37] shadow-[0_0_20px_rgba(212,175,55,0.3)]' : 'bg-slate-50 border-[#040F2D]/10 hover:border-[#040F2D]/20'}
                        ${isCurrent ? 'scale-110' : 'scale-100'}
                      `}
                    >
                      <step.icon className={`w-4 h-4 sm:w-5 sm:h-5 transition-colors duration-700 ${isActive ? 'text-[#D4AF37]' : 'text-[#040F2D]/40'}`} />
                    </motion.div>

                    {/* Text Details */}
                    <div className="text-left flex-1 min-w-[120px]">
                      <h4 className={`text-lg sm:text-xl font-bold transition-colors duration-700 ${isActive ? 'text-[#040F2D]' : 'text-[#040F2D]/40'}`}>
                        {step.label}
                      </h4>
                      <p className={`text-xs sm:text-sm mt-0.5 transition-all duration-700 leading-relaxed ${isCurrent ? 'text-slate-600 opacity-100 h-auto' : 'text-transparent opacity-0 h-0 overflow-hidden'}`}>
                        {step.desc}
                      </p>
                    </div>
                  </div>
          ...
          <div className="lg:col-span-4 h-full hidden lg:block">
            <div className="w-full h-full min-h-[300px] rounded-2xl overflow-hidden relative border border-[#040F2D]/10 shadow-2xl">
              ...
              <div className="absolute bottom-6 left-6 z-20">
                <p className="text-white font-bold text-lg leading-tight">Data-Driven <br/><span className="text-[#D4AF37]">Precision</span></p>
              </div>
            </div>
          </div>
        </div>
