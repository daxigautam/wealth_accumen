...
export const testimonials = [
  {
    name: "Manisha Kahate",
    text: "My sincere thanks to Mr. Atharva of Wealth Acumen for providing the knowledge of stock market in a very simple but clear ways by using different charts and different methods. Your knowledge and clear explanations have significantly enhanced my understanding of the subject. I would recommend Wealth Acumen who wants to learn trading. Thank you for your service and hope to get more knowledge in future.",
  },
  {
    name: "Rupesh Gupta",
    text: "Wealth Acumen helped me understand how knowledge and psychology play a key role in investing. I applied what I learned and have already started seeing positive results.",
  },
  {
  ...
  },
  {
    ...
    text: "Wealth Acumen has been instrumental in reshaping my financial portfolio. The continuous support, market insights, and tailored advice have given me immense confidence in my long-term wealth creation journey.",
  },
  {
    name: "Sneha Patil",
    text: "I was always hesitant about investing in the stock market, but Atharva made the entire process so easy to understand. From mutual funds to direct equity, his guidance has been invaluable. Highly recommended for beginners and experts alike!",
  },
];

export const compoundingContent = {
  title: "The Power of Compounding: Start Early, Grow Steadily",
  description:
    "This chart shows how a consistent investment, say through SIPs, can grow exponentially over time. With just \u20B92.2 lakhs in the early years, your wealth can potentially grow to over \u20B918.5 lakhs in 15 years! Compounding rewards patience. The longer you stay invested, the greater your returns. At Wealth Acumen, we help you harness this power through disciplined, goal-based investing. Whether you're planning for retirement, your child's education, or financial independence, starting today makes all the difference.",
};
...
export const aboutContent = {
  ...
  angelOneBenefits: [
    "Cutting-edge technology for trading and investments",
    "Research-backed insights to make informed financial decisions",
    "Personalized support and assistance throughout their investment journey",
    "A trusted, transparent, and compliant investment environment",
...
export const proprietor = {
  ...
  bio: "AMFI-Registered Mutual Fund Distributor with additional certifications in Equity Derivatives and NISM-Certified Research Analyst. With over 4 years of hands-on experience in the stock market. As a Channel Partner of Angel One, I provide clients with access to a wide range of investment products and trading platforms. My focus is on delivering insightful, research-backed guidance to help investors make informed decisions and build long-term wealth.",
};
...
export const faqs = [
  {
    ...
    answer:
      "Wealth Acumen is a financial services platform that helps individuals invest in the stock market and mutual funds with confidence. We are an authorized channel partner of Angel One Ltd., offering access to research-backed investment tools, education, and client support.",
  },
  {
    question: "Are you SEBI registered?",
    answer:
      "We are not SEBI-registered as an Investment Advisor or Research Analyst. We operate as a channel partner of Angel One Ltd., which is a SEBI-registered stockbroker.",
  },
  {
    question: "Do you provide stock recommendations?",
    answer:
      "No, we do not provide independent stock recommendations or personalized investment advice. Any research reports or market insights shared by us are sourced directly from Angel One's official research desk.",
  },
  {
    question: "What services do you offer?",
    answer:
      "Stock market investing through Angel One, mutual fund investments (both online and offline available), research content sourced from Angel One, basic investment education and awareness, client onboarding and support.",
  },
  {
    question: "How do I open a Demat and Trading Account with you?",
    answer:
      "You can open a Demat & Trading account with Angel One through our referral link. We'll guide you through the process and assist with KYC and setup.",
  },
  {
    question: "Do you charge any fees for your services?",
    answer:
      "We do not charge clients directly for our services. We earn commissions from Angel One and mutual fund companies. There are no hidden charges from our side.",
  },
  {
    question: "Is my investment safe?",
    answer:
      "All investments are made through trusted platforms like Angel One and SEBI-registered AMCs. However, market investments are subject to risks. We always recommend investing based on your risk profile and financial goals.",
  },
  {
    question: "Do you offer investment courses or training?",
    answer:
      "At the moment we do not offer courses or training but we provide webinars conducted by AMCs and Angel One, and may soon launch structured stock market learning programs for beginners and young investors.",
  },
  {
    question: "How can I get in touch with you?",
    answer:
      "You can contact us via WhatsApp, Instagram, or email. We're always available to assist with your queries and investment needs.",
  },
];
...
export const diyContent = {
  ...
  description:
    "We understand that many people today prefer not to receive frequent sales calls or investment pitches. That's why we offer a Do It Yourself option for your convenience. Simply scan the QR code below and download the Angel One app, your one-stop platform for all types of investment products, including stocks, mutual funds, ETFs, IPOs, and more. Whether you're a beginner or an experienced investor, Wealth Acumen is here to support and guide you throughout your investment journey. Start investing on your own terms, anytime, anywhere.",
};

export const disclaimerContent = {
  title: "Disclaimer",
  subtitle: "Wealth Acumen Investment Services",
  paragraphs: [
    "Wealth Acumen Investment Services operates as a channel partner of Angel One Ltd. We are authorized to facilitate investment services through Empanelled AMC's and Angel One's platform, including equity trading, mutual funds, and other market-linked products.",
    "Wealth Acumen does not hold any SEBI registration as a Research Analyst, Investment Advisor, or Portfolio Manager. As such, we do not provide any independent stock recommendations, investment advice, or personalized financial planning.",
    "All research reports, stock insights, market views, and investment-related information shared by us are sourced directly from Angel One Ltd., a SEBI-registered stockbroker and research provider. We do not alter, interpret, or provide additional recommendations beyond what is officially published by Angel One.",
    "Investing in the stock market involves risks, including the potential loss of principal. Past performance is not indicative of future returns. Investors are advised to read all scheme-related documents, consult certified professionals if required, and invest based on their own risk appetite and financial goals.",
  ],
  acknowledgements: [
    "You are responsible for your investment decisions.",
    "You understand that Wealth Acumen only shares research information published by Angel One.",
    "You are not receiving personalized investment advice.",
    "You agree that Wealth Acumen will not be liable for any direct or indirect financial loss arising from investment decisions made by you.",
  ],
};

export const disclosureContent = {
  title: "Disclosure",
  subtitle: "Disclosure, Wealth Acumen Investment Services",
  points: [
    "Wealth Acumen Investment Services operates as an authorized channel partner of Angel One Ltd., a SEBI-registered stockbroker (SEBI Reg. No.: INZ000161534).",
    "We do not hold any SEBI registration as an Investment Advisor or Research Analyst. Therefore, we do not provide independent investment advice or stock recommendations.",
    "Any research content, market updates, or investment-related information shared by us is sourced from Angel One Ltd. and is not our own opinion or recommendation.",
    "We may receive commissions or incentives from Angel One and other AMCs (Asset Management Companies) on the basis of client investments made through us.",
    "Investments in the stock market and mutual funds are subject to market risks. Clients are advised to read all scheme-related documents carefully.",
    "Wealth Acumen does not guarantee any returns or profits.",
  ],
};
