      ...
      <section className="relative pt-32 pb-16 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 text-center">
          ...
          >
            <Link
              href="/#empower"
              className="inline-flex items-center gap-2 text-sm text-[#D4AF37] hover:text-white transition-all duration-300 border border-[#D4AF37]/30 hover:border-[#D4AF37]/60 rounded-full px-4 py-1.5 bg-[#040F2D] backdrop-blur-sm shadow-md hover:bg-[#0B1736]"
            >
              <svg
          ...
          <motion.h1
            ...
            className="font-[family-name:var(--font-outfit)] text-4xl sm:text-5xl md:text-6xl font-light text-[#040F2D] mb-4"
          >
          ...
          <motion.p
            ...
            className="text-lg text-[#040F2D] max-w-2xl mx-auto"
          >
          ...
          <FadeInSection>
            <div className="mb-10">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h2 className="font-[family-name:var(--font-outfit)] text-2xl sm:text-3xl font-light text-[#040F2D]">
                  Check your KYC Status
                </h2>
              </div>
              <p className="text-[#040F2D] ml-[52px]">
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium text-[#040F2D] group-hover:text-[#D4AF37] transition-colors">
                          {portal.name}
                        </p>
                        <p className="text-xs text-[#040F2D]">Check status</p>
                      </div>
                    </div>
                    <svg className="w-4 h-4 text-[#040F2D] group-hover:text-[#D4AF37] transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-[#040F2D]">Validate KYC</p>
                      </div>
                    </div>
                    <svg className="w-4 h-4 text-[#040F2D] group-hover:text-[#D4AF37] transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 5.25 21h10.5A2.25 2.25 0 0 0 18 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-[#040F2D]">PDF Document</p>
                      </div>
                    </div>
                    <svg className="w-5 h-5 text-[#040F2D] group-hover:text-[#D4AF37] transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M16.5 12 12 16.5m0 0L7.5 12m4.5 4.5V3" />
                    </svg>
                  </div>
                </a>
