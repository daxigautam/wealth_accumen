            ...
            <div className="space-y-6">
              ...
              <FadeInSection delay={0.1}>
                <div className="glass glass-hover rounded-2xl p-8">
                  <h2 className="font-[family-name:var(--font-outfit)] text-xl font-light text-[#040F2D] mb-6">
                    Contact Information
                  </h2>
                  ...
                  <div className="space-y-5">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-[#040F2D]/70 group-hover:text-[#D4AF37] transition-colors">
                          {brand.email}
                        </p>
                      </div>
                    </a>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-[#040F2D]/70 group-hover:text-cyan-600 transition-colors">
                          {brand.phone}
                        </p>
                      </div>
                    </a>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-[#040F2D]/70 leading-relaxed">
                          {brand.address}
                        </p>
                      </div>
                    </div>
                ...
                <div className="glass glass-hover rounded-2xl p-8">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    >
                      ...
                      <div>
                        <p className="text-sm font-light text-[#040F2D] group-hover:text-pink-600 transition-colors">Instagram</p>
                    ...
                    >
                      ...
                      <div>
                        <p className="text-sm font-light text-[#040F2D] group-hover:text-green-600 transition-colors">WhatsApp</p>
              ...
              <FadeInSection delay={0.3}>
                <div className="glass rounded-2xl p-8 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <h2 className="font-[family-name:var(--font-outfit)] text-xl font-light text-[#040F2D] mb-3">
                      Open a Demat Account
                    </h2>
                    <p className="text-sm text-[#040F2D]/70 leading-relaxed mb-5">
