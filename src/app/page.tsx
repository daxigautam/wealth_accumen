            ...
            <FadeIn delay={0.1} className="w-[85vw] sm:w-[380px] lg:w-[420px] shrink-0 snap-center h-[320px] sm:h-[340px]">
              <Link href="/services/equity" className="group block relative w-full h-full rounded-3xl overflow-hidden bg-white backdrop-blur-md border border-[#D4AF37]/20 hover:border-[#D4AF37]/50 transition-all duration-500 shadow-lg hover:shadow-[0_10px_40px_rgba(212,175,55,0.2)] hover:-translate-y-2">
                ...
                <div className="p-6 sm:p-8 h-full flex flex-col justify-between relative z-10">
                  ...
                  <div>
                    <h3 className="font-[family-name:var(--font-playfair)] text-xl sm:text-2xl font-light text-[#040F2D] transition-colors duration-500 mb-2 sm:mb-3">Equity Advisory</h3>
                    <p className="text-gray-600 transition-colors duration-500 text-sm sm:text-base line-clamp-3">Exclusive access to premium equity research, portfolio strategies, and direct market participation.</p>
                  </div>
                </div>
              </Link>
            </FadeIn>
            ...
            <FadeIn delay={0.2} className="w-[85vw] sm:w-[380px] lg:w-[420px] shrink-0 snap-center h-[320px] sm:h-[340px]">
              <Link href="/services/mutual-funds" className="group block relative w-full h-full rounded-3xl overflow-hidden bg-white backdrop-blur-md border border-[#D4AF37]/20 hover:border-[#D4AF37]/50 transition-all duration-500 shadow-lg hover:shadow-[0_10px_40px_rgba(212,175,55,0.2)] hover:-translate-y-2">
                ...
                <div className="p-6 sm:p-8 h-full flex flex-col justify-between relative z-10">
                  ...
                  <div>
                    <h3 className="font-[family-name:var(--font-playfair)] text-xl sm:text-2xl font-light text-[#040F2D] transition-colors duration-500 mb-2 sm:mb-3">Mutual Funds</h3>
                    <p className="text-gray-600 transition-colors duration-500 text-sm sm:text-base line-clamp-3">Curated selection of top-tier funds perfectly aligned with your long-term life goals.</p>
                  </div>
                </div>
              </Link>
            </FadeIn>
            ...
            <FadeIn delay={0.3} className="w-[85vw] sm:w-[380px] lg:w-[420px] shrink-0 snap-center h-[320px] sm:h-[340px]">
              <Link href="/services/etfs" className="group block relative w-full h-full rounded-3xl overflow-hidden bg-white backdrop-blur-md border border-[#D4AF37]/20 hover:border-[#D4AF37]/50 transition-all duration-500 shadow-lg hover:shadow-[0_10px_40px_rgba(212,175,55,0.2)] hover:-translate-y-2">
                ...
                <div className="p-6 sm:p-8 h-full flex flex-col justify-between relative z-10">
                  ...
                  <div>
                    <h3 className="font-[family-name:var(--font-playfair)] text-xl sm:text-2xl font-light text-[#040F2D] transition-colors duration-500 mb-2 sm:mb-3">ETFs</h3>
                    <p className="text-gray-600 transition-colors duration-500 text-sm sm:text-base line-clamp-3">Smart, low-cost diversification across global markets for maximum returns.</p>
                  </div>
                </div>
              </Link>
            </FadeIn>
            ...
            <FadeIn delay={0.4} className="w-[85vw] sm:w-[380px] lg:w-[420px] shrink-0 snap-center h-[320px] sm:h-[340px]">
              <Link href="/services/insurance" className="group block relative w-full h-full rounded-3xl overflow-hidden bg-white backdrop-blur-md border border-[#D4AF37]/20 hover:border-[#D4AF37]/50 transition-all duration-500 shadow-lg hover:shadow-[0_10px_40px_rgba(212,175,55,0.2)] hover:-translate-y-2">
                ...
                <div className="p-6 sm:p-8 h-full flex flex-col justify-between relative z-10">
                  ...
                  <div>
                    <h3 className="font-[family-name:var(--font-playfair)] text-xl sm:text-2xl font-light text-[#040F2D] transition-colors duration-500 mb-2 sm:mb-3">Insurance</h3>
                    <p className="text-gray-600 transition-colors duration-500 text-sm sm:text-base line-clamp-3">Comprehensive protection for your wealth, life, and future generations.</p>
                  </div>
                </div>
              </Link>
            </FadeIn>
            ...
            <FadeIn delay={0.5} className="w-[85vw] sm:w-[380px] lg:w-[420px] shrink-0 snap-center h-[320px] sm:h-[340px]">
              <Link href="/services/bonds" className="group block relative w-full h-full rounded-3xl overflow-hidden bg-white backdrop-blur-md border border-[#D4AF37]/20 hover:border-[#D4AF37]/50 transition-all duration-500 shadow-lg hover:shadow-[0_10px_40px_rgba(212,175,55,0.2)] hover:-translate-y-2">
                ...
                <div className="p-6 sm:p-8 h-full flex flex-col justify-between relative z-10">
                  ...
                  <div>
                    <h3 className="font-[family-name:var(--font-playfair)] text-xl sm:text-2xl font-light text-[#040F2D] transition-colors duration-500 mb-2 sm:mb-3">Fixed Income</h3>
                    <p className="text-gray-600 transition-colors duration-500 text-sm sm:text-base line-clamp-3">Stable, predictable yields and absolute peace of mind for conservative allocation.</p>
                  </div>
                </div>
              </Link>
            </FadeIn>
      ...
      <section className="pt-12 pb-12 sm:pt-16 sm:pb-16 bg-[var(--background)] transition-colors duration-500 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <FadeIn delay={0.1}>
              <Link href="/blog" className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-[#D4AF37] to-[#C59B27] text-[#040F2D] font-medium hover:from-[#C59B27] hover:to-[#B58A18] hover:gap-3 transition-all duration-300 shadow-md hover:shadow-lg hover:shadow-[#D4AF37]/30">
                View all articles
